...
# print(f"Order: {table01.bill}")
table01.order("Burrito", 20.43, 3)
table01.remove("Burrito", 20.43, 2)
print(f"The current table bill includes: ")
print(table01.bill)
print(f"The current subtotal is: ")
print(table01.get_subtotal())
print("The current total is: ")
print(table01.get_total(0.15))
print("This price per person is: ")
